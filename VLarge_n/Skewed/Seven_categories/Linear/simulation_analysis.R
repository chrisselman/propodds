...
setwd("/group/cebu1/BACKUP/Chris/Project_2/Main_Simulations/VLarge_n/Skewed/Seven_categories/Linear")
...
load("largen_skew_7cat_linear_dataset.Rdata")
attach(big_data)
...
save(data, file = paste0("largen_skew_7cat_linear",datnum,".Rdata"))

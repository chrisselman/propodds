...
setwd("/group/cebu1/BACKUP/Chris/Project_2/Main_Simulations/VLarge_n/Skewed/Eleven_categories/Linear")
...
load("largen_skew_11cat_linear_dataset.Rdata")
attach(big_data)
...
save(data, file = paste0("largen_skew_11cat_linear",datnum,".Rdata"))

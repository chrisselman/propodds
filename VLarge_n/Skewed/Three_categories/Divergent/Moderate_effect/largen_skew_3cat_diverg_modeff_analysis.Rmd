...
```{r}
library(miceadds)
data <- do.call(rbind,lapply(paste0("largen_skew_3cat_diverg_modeff",1:50,".Rdata"), load.Rdata2))
...
effectsize <- rep("Moderate [1.50]", 10)

truemod <- rep("Divergent", 10)
...
save(results, file = "vlargen_skew_3cat_diverg_modeff_results.Rdata")

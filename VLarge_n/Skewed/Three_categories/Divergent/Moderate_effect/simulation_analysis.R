...
setwd("/group/cebu1/BACKUP/Chris/Project_2/Main_Simulations/VLarge_n/Skewed/Three_categories/Divergent/Moderate_effect")
...
load("largen_skew_3cat_diverg_modeff_dataset.Rdata")
attach(big_data)
...
save(data, file = paste0("largen_skew_3cat_diverg_modeff",datnum,".Rdata"))

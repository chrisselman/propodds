...
setwd("/group/cebu1/BACKUP/Chris/Project_2/Main_Simulations/VLarge_n/Skewed/Three_categories/Linear")
...
save(big_data, file = "largen_skew_3cat_linear_dataset.Rdata")

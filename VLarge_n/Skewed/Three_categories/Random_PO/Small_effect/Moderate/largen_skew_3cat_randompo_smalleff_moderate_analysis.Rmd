...
```{r}
library(miceadds)
data <- do.call(rbind,lapply(paste0("largen_skew_3cat_randompo_smalleff_moderate",1:50,".Rdata"), load.Rdata2))
...
save(results, file = "vlargen_skew_3cat_randompo_smalleff_moderate_results.Rdata")
write.csv(results,file="G:/BACKUP/Chris/Project_2/Main_Simulations/Results/results_161.csv")

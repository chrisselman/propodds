...
setwd("/group/cebu1/BACKUP/Chris/Project_2/Main_Simulations/VLarge_n/Symmetric/Eleven_categories/Linear")
...
load("largen_sym_11cat_linear_dataset.Rdata")
attach(big_data)
...
save(data, file = paste0("largen_sym_11cat_linear",datnum,".Rdata"))

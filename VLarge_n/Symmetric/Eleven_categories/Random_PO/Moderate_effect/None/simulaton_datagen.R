...
setwd("/group/cebu1/BACKUP/Chris/Project_2/Main_Simulations/VLarge_n/Symmetric/Eleven_categories/Random_PO/Moderate_effect/None")
...
save(big_data, file = "largen_sym_11cat_randompo_modeff_none_dataset.Rdata")

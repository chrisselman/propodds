...
setwd("/group/cebu1/BACKUP/Chris/Project_2/Main_Simulations/VLarge_n/Symmetric/Eleven_categories/Random_PO/Moderate_effect/Slight")
...
save(big_data, file = "largen_sym_11cat_randompo_modeff_slight_dataset.Rdata")

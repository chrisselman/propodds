---
title: "small_skew_11cat_randompo_modeff_slight_analysis"
...
```{r}
library(miceadds)
data <- do.call(rbind,lapply(paste0("largen_sym_11cat_randompo_smalleff_slight",c(1:50),".Rdata"), load.Rdata2))
...
truemod <- rep("Random PO [slight violation]", 50)
...
save(results, file = "vlargen_sym_11cat_randompo_smalleff_slight_results.Rdata")
write.csv(results,file="G:/BACKUP/Chris/Project_2/Main_Simulations/Results/results_133.csv",row.names=F)

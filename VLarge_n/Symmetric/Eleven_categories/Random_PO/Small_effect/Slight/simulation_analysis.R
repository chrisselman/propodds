...
setwd("/group/cebu1/BACKUP/Chris/Project_2/Main_Simulations/VLarge_n/Symmetric/Eleven_categories/Random_PO/Small_effect/Slight")
...
load("largen_sym_11cat_randompo_smalleff_slight_dataset.Rdata")
attach(big_data)
...
save(data, file = paste0("largen_sym_11cat_randompo_smalleff_slight",datnum,".Rdata"))

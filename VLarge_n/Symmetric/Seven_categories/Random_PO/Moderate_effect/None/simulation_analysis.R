...
setwd("/group/cebu1/BACKUP/Chris/Project_2/Main_Simulations/VLarge_n/Symmetric/Seven_categories/Random_PO/Moderate_effect/None")
...
load("largen_sym_7cat_randompo_modeff_none_dataset.Rdata")
attach(big_data)
...
save(data, file = paste0("largen_sym_7cat_randompo_modeff_none",datnum,".Rdata"))

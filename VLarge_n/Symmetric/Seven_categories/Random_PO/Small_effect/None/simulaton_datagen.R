...
setwd("/group/cebu1/BACKUP/Chris/Project_2/Main_Simulations/VLarge_n/Symmetric/Seven_categories/Random_PO/Small_effect/None")
...
save(big_data, file = "largen_sym_7cat_randompo_smalleff_none_dataset.Rdata")

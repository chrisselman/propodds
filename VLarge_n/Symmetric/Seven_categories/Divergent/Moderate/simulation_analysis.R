...
setwd("/group/cebu1/BACKUP/Chris/Project_2/Main_Simulations/VLarge_n/Symmetric/Seven_categories/Divergent/Moderate")
...
load("largen_sym_7cat_diverg_moderate_dataset.Rdata")
attach(big_data)
...
save(data, file = paste0("largen_sym_7cat_diverg_moderate",datnum,".Rdata"))

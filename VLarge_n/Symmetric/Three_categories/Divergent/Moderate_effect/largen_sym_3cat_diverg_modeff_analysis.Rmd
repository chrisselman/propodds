...
```{r}
library(miceadds)
data <- do.call(rbind,lapply(paste0("largen_sym_3cat_diverg_modeff",1:50,".Rdata"), load.Rdata2))
...
save(results, file = "vlargen_sym_3cat_diverg_modeff_results.Rdata")
write.csv(results,file="G:/BACKUP/Chris/Project_2/Main_Simulations/Results/results_145.csv")

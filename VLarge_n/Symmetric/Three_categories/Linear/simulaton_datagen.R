...
setwd("/group/cebu1/BACKUP/Chris/Project_2/Main_Simulations/VLarge_n/Symmetric/Three_categories/Linear")
...
save(big_data, file = "largen_sym_3cat_linear_dataset.Rdata")

...
```{r}
library(miceadds)
data <- do.call(rbind,lapply(paste0("largen_sym_3cat_linear",1:50,".Rdata"), load.Rdata2))
...
save(results, file = "vlargen_sym_3cat_linear_results.Rdata")
write.csv(results,paste("G:/BACKUP/Chris/Project_2/Main_Simulations/Results/results_147.csv"),row.names=F)

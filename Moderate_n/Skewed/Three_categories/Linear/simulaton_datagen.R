...
setwd("/group/cebu1/BACKUP/Chris/Project_2/Main_Simulations/Moderate_n/Skewed/Three_categories/Linear")
...
save(big_data, file = "smalln_skew_3cat_linear_dataset.Rdata")

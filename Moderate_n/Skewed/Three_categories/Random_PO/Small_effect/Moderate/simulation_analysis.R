...
setwd("/group/cebu1/BACKUP/Chris/Project_2/Main_Simulations/Moderate_n/Skewed/Three_categories/Random_PO/Small_effect/Moderate")
...
load("smalln_skew_3cat_randompo_smalleff_moderate_dataset.Rdata")
attach(big_data)
...
save(data, file = paste0("smalln_skew_3cat_randompo_smalleff_moderate",datnum,".Rdata"))

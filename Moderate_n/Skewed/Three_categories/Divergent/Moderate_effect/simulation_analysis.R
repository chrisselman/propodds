...
setwd("/group/cebu1/BACKUP/Chris/Project_2/Main_Simulations/Moderate_n/Skewed/Three_categories/Divergent/Moderate_effect")
...
load("smalln_skew_3cat_diverg_modeff_dataset.Rdata")
attach(big_data)
...
save(data, file = paste0("smalln_skew_3cat_diverg_modeff",datnum,".Rdata"))

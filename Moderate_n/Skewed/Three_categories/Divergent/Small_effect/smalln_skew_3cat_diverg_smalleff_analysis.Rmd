...
```{r}
library(miceadds)
data <- do.call(rbind,lapply(paste0("smalln_skew_3cat_diverg_smalleff",1:50,".Rdata"), load.Rdata2))
...
save(results, file = "smalln_skew_3cat_diverg_smalleff_results.Rdata")
write.csv(results,file="G:/BACKUP/Chris/Project_2/Main_Simulations/Results/results_43.csv")

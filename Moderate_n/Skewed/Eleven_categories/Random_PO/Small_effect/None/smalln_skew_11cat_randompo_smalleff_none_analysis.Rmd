...
#for (i in 1:100) {
 # load(paste0("smalln_skew_11cat_randompo_modeff_none",i,".Rdata"))
  #save(data,file = paste0("smalln_skew_11cat_randompo_smalleff_none",i,".Rdata"))
#}


data <- do.call(rbind,lapply(paste0("smalln_skew_11cat_randompo_smalleff_none",c(1:100),".Rdata"), load.Rdata2))
...
save(results, file = "smalln_skew_13cat_randompo_smalleff_none_results.Rdata")
write.csv(results,file="G:/BACKUP/Chris/Project_2/Main_Simulations/Results/results_8.csv")

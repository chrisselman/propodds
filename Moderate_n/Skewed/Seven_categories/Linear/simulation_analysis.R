...
setwd("/group/cebu1/BACKUP/Chris/Project_2/Main_Simulations/Moderate_n/Skewed/Seven_categories/Linear")
...
load("smalln_skew_7cat_linear_dataset.Rdata")
attach(big_data)
...
save(data, file = paste0("smalln_skew_7cat_linear",datnum,".Rdata"))

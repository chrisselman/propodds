...
setwd("/group/cebu1/BACKUP/Chris/Project_2/Main_Simulations/Moderate_n/Skewed/Seven_categories/Divergent/Slight")
...
load("smalln_skew_7cat_diverg_slight_dataset.Rdata")
attach(big_data)
...
save(data, file = paste0("smalln_skew_7cat_diverg_slight",datnum,".Rdata"))

...
setwd("/group/cebu1/BACKUP/Chris/Project_2/Main_Simulations/Moderate_n/Symmetric/Eleven_categories/Divergent/Moderate")
...
load("smalln_sym_11cat_diverg_moderate_dataset.Rdata")
attach(big_data)
...
save(data, file = paste0("smalln_sym_11cat_diverg_moderate",datnum,".Rdata"))

...
setwd("/group/cebu1/BACKUP/Chris/Project_2/Main_Simulations/Moderate_n/Symmetric/Eleven_categories/Linear")
...
load("smalln_sym_11cat_linear_dataset.Rdata")
attach(big_data)
...
for (k in s1[datnum]:s2[datnum]){
  ...
  bias_cumlogit_po1[k] <- as.numeric(summarise_draws(df, "median")[11,2]) - (log(0.8) + 0.06*0)
  bias_cumlogit_po2[k] <- as.numeric(summarise_draws(df, "median")[11,2]) - (log(0.8) + 0.06*1)
  bias_cumlogit_po3[k] <- as.numeric(summarise_draws(df, "median")[11,2]) - (log(0.8) + 0.06*2)
  bias_cumlogit_po4[k] <- as.numeric(summarise_draws(df, "median")[11,2]) - (log(0.8) + 0.06*3)
  bias_cumlogit_po5[k] <- as.numeric(summarise_draws(df, "median")[11,2]) - (log(0.8) + 0.06*4)
  bias_cumlogit_po6[k] <- as.numeric(summarise_draws(df, "median")[11,2]) - (log(0.8) + 0.06*5)
  bias_cumlogit_po7[k] <- as.numeric(summarise_draws(df, "median")[11,2]) - (log(0.8) + 0.06*6)
  bias_cumlogit_po8[k] <- as.numeric(summarise_draws(df, "median")[11,2]) - (log(0.8) + 0.06*7)
  bias_cumlogit_po9[k] <- as.numeric(summarise_draws(df, "median")[11,2]) - (log(0.8) + 0.06*8)
  bias_cumlogit_po10[k] <- as.numeric(summarise_draws(df, "median")[11,2]) - (log(0.8) + 0.06*9)
  ...
  cv_cumlogit_po1[k] <- ifelse(lci < (log(0.8) + 0.06*0) & uci > (log(0.8) + 0.06*0), 1, 0)
  cv_cumlogit_po2[k] <- ifelse(lci < (log(0.8) + 0.06*1) & uci > (log(0.8) + 0.06*1), 1, 0)
  cv_cumlogit_po3[k] <- ifelse(lci < (log(0.8) + 0.06*2) & uci > (log(0.8) + 0.06*2), 1, 0)
  cv_cumlogit_po4[k] <- ifelse(lci < (log(0.8) + 0.06*3) & uci > (log(0.8) + 0.06*3), 1, 0)
  cv_cumlogit_po5[k] <- ifelse(lci < (log(0.8) + 0.06*4) & uci > (log(0.8) + 0.06*4), 1, 0)
  cv_cumlogit_po6[k] <- ifelse(lci < (log(0.8) + 0.06*5) & uci > (log(0.8) + 0.06*5), 1, 0)
  cv_cumlogit_po7[k] <- ifelse(lci < (log(0.8) + 0.06*6) & uci > (log(0.8) + 0.06*6), 1, 0)
  cv_cumlogit_po8[k] <- ifelse(lci < (log(0.8) + 0.06*7) & uci > (log(0.8) + 0.06*7), 1, 0)
  cv_cumlogit_po9[k] <- ifelse(lci < (log(0.8) + 0.06*8) & uci > (log(0.8) + 0.06*8), 1, 0)
  cv_cumlogit_po10[k] <- ifelse(lci < (log(0.8) + 0.06*9) & uci > (log(0.8) + 0.06*9), 1, 0)

  
  # MSE 
  mse_cumlogit_po1[k] <- (as.numeric(summarise_draws(df, "median")[11,2]) - (log(0.8) + 0.06*0))^2
  mse_cumlogit_po2[k] <- (as.numeric(summarise_draws(df, "median")[11,2]) - (log(0.8) + 0.06*1))^2
  mse_cumlogit_po3[k] <- (as.numeric(summarise_draws(df, "median")[11,2]) - (log(0.8) + 0.06*2))^2
  mse_cumlogit_po4[k] <- (as.numeric(summarise_draws(df, "median")[11,2]) - (log(0.8) + 0.06*3))^2
  mse_cumlogit_po5[k] <- (as.numeric(summarise_draws(df, "median")[11,2]) - (log(0.8) + 0.06*4))^2
  mse_cumlogit_po6[k] <- (as.numeric(summarise_draws(df, "median")[11,2]) - (log(0.8) + 0.06*5))^2
  mse_cumlogit_po7[k] <- (as.numeric(summarise_draws(df, "median")[11,2]) - (log(0.8) + 0.06*6))^2
  mse_cumlogit_po8[k] <- (as.numeric(summarise_draws(df, "median")[11,2]) - (log(0.8) + 0.06*7))^2
  mse_cumlogit_po9[k] <- (as.numeric(summarise_draws(df, "median")[11,2]) - (log(0.8) + 0.06*8))^2
  mse_cumlogit_po10[k] <- (as.numeric(summarise_draws(df, "median")[11,2]) - (log(0.8) + 0.06*9))^2
  ...
  # Extract summary for proportional OR 
  # Bias for each cumulative logit 
  bias_cumlogit_ppo1[k] <- as.numeric(summarise_draws(df, "median")[11,2]) - (log(0.8) + 0.06*0)
  bias_cumlogit_ppo2[k] <- as.numeric(summarise_draws(phi1, "median")[1,2]) - (log(0.8) + 0.06*1)
  bias_cumlogit_ppo3[k] <- as.numeric(summarise_draws(phi2, "median")[1,2]) - (log(0.8) + 0.06*2)
  bias_cumlogit_ppo4[k] <- as.numeric(summarise_draws(phi3, "median")[1,2]) - (log(0.8) + 0.06*3)
  bias_cumlogit_ppo5[k] <- as.numeric(summarise_draws(phi4, "median")[1,2]) - (log(0.8) + 0.06*4)
  bias_cumlogit_ppo6[k] <- as.numeric(summarise_draws(phi5, "median")[1,2]) - (log(0.8) + 0.06*5)
  bias_cumlogit_ppo7[k] <- as.numeric(summarise_draws(phi6, "median")[1,2]) - (log(0.8) + 0.06*6)
  bias_cumlogit_ppo8[k] <- as.numeric(summarise_draws(phi7, "median")[1,2]) - (log(0.8) + 0.06*7)
  bias_cumlogit_ppo9[k] <- as.numeric(summarise_draws(phi8, "median")[1,2]) - (log(0.8) + 0.06*8)
  bias_cumlogit_ppo10[k] <- as.numeric(summarise_draws(phi9, "median")[1,2]) - (log(0.8) + 0.06*9)
  ...
  cv_cumlogit_ppo1[k] <- ifelse(lci1 < (log(0.8) + 0.06*0) & uci1 > (log(0.8) + 0.06*0), 1, 0)
  cv_cumlogit_ppo2[k] <- ifelse(lci2 < (log(0.8) + 0.06*1) & uci2 > (log(0.8) + 0.06*1), 1, 0)
  cv_cumlogit_ppo3[k] <- ifelse(lci3 < (log(0.8) + 0.06*2) & uci3 > (log(0.8) + 0.06*2), 1, 0)
  cv_cumlogit_ppo4[k] <- ifelse(lci4 < (log(0.8) + 0.06*3) & uci4 > (log(0.8) + 0.06*3), 1, 0)
  cv_cumlogit_ppo5[k] <- ifelse(lci5 < (log(0.8) + 0.06*4) & uci5 > (log(0.8) + 0.06*4), 1, 0)
  cv_cumlogit_ppo6[k] <- ifelse(lci6 < (log(0.8) + 0.06*5) & uci6 > (log(0.8) + 0.06*5), 1, 0)
  cv_cumlogit_ppo7[k] <- ifelse(lci7 < (log(0.8) + 0.06*6) & uci7 > (log(0.8) + 0.06*6), 1, 0)
  cv_cumlogit_ppo8[k] <- ifelse(lci8 < (log(0.8) + 0.06*7) & uci8 > (log(0.8) + 0.06*7), 1, 0)
  cv_cumlogit_ppo9[k] <- ifelse(lci9 < (log(0.8) + 0.06*8) & uci9 > (log(0.8) + 0.06*8), 1, 0)
  cv_cumlogit_ppo10[k] <- ifelse(lci10 < (log(0.8) + 0.06*9) & uci10 > (log(0.8) + 0.06*9), 1, 0)

  
  # MSE 
  mse_cumlogit_ppo1[k] <- (as.numeric(summarise_draws(df, "median")[11,2]) - (log(0.8) + 0.06*0))^2
  mse_cumlogit_ppo2[k] <- (as.numeric(summarise_draws(phi1, "median")[1,2]) - (log(0.8) + 0.06*1))^2
  mse_cumlogit_ppo3[k] <- (as.numeric(summarise_draws(phi2, "median")[1,2]) - (log(0.8) + 0.06*2))^2
  mse_cumlogit_ppo4[k] <- (as.numeric(summarise_draws(phi3, "median")[1,2]) - (log(0.8) + 0.06*3))^2
  mse_cumlogit_ppo5[k] <- (as.numeric(summarise_draws(phi4, "median")[1,2]) - (log(0.8) + 0.06*4))^2
  mse_cumlogit_ppo6[k] <- (as.numeric(summarise_draws(phi5, "median")[1,2]) - (log(0.8) + 0.06*5))^2
  mse_cumlogit_ppo7[k] <- (as.numeric(summarise_draws(phi6, "median")[1,2]) - (log(0.8) + 0.06*6))^2
  mse_cumlogit_ppo8[k] <- (as.numeric(summarise_draws(phi7, "median")[1,2]) - (log(0.8) + 0.06*7))^2
  mse_cumlogit_ppo9[k] <- (as.numeric(summarise_draws(phi8, "median")[1,2]) - (log(0.8) + 0.06*8))^2
  mse_cumlogit_ppo10[k] <- (as.numeric(summarise_draws(phi9, "median")[1,2]) - (log(0.8) + 0.06*9))^2
  ...
  # Extract summary for proportional OR 
  # Bias for each cumulative logit 
  bias_cumlogit_lcpo1[k] <- as.numeric(summarise_draws(phi1, "median")[1,2]) - (log(0.8) + 0.06*0)
  bias_cumlogit_lcpo2[k] <- as.numeric(summarise_draws(phi2, "median")[1,2]) - (log(0.8) + 0.06*1)
  bias_cumlogit_lcpo3[k] <- as.numeric(summarise_draws(phi3, "median")[1,2]) - (log(0.8) + 0.06*2)
  bias_cumlogit_lcpo4[k] <- as.numeric(summarise_draws(phi4, "median")[1,2]) - (log(0.8) + 0.06*3)
  bias_cumlogit_lcpo5[k] <- as.numeric(summarise_draws(phi5, "median")[1,2]) - (log(0.8) + 0.06*4)
  bias_cumlogit_lcpo6[k] <- as.numeric(summarise_draws(phi6, "median")[1,2]) - (log(0.8) + 0.06*5)
  bias_cumlogit_lcpo7[k] <- as.numeric(summarise_draws(phi7, "median")[1,2]) - (log(0.8) + 0.06*6)
  bias_cumlogit_lcpo8[k] <- as.numeric(summarise_draws(phi8, "median")[1,2]) - (log(0.8) + 0.06*7)
  bias_cumlogit_lcpo9[k] <- as.numeric(summarise_draws(phi9, "median")[1,2]) - (log(0.8) + 0.06*8)
  bias_cumlogit_lcpo10[k] <- as.numeric(summarise_draws(phi10, "median")[1,2]) - (log(0.8) + 0.06*9)
  ...
  cv_cumlogit_lcpo1[k] <- ifelse(lci1 < (log(0.8) + 0.06*0) & uci1 > (log(0.8) + 0.06*0), 1, 0)
  cv_cumlogit_lcpo2[k] <- ifelse(lci2 < (log(0.8) + 0.06*1) & uci2 > (log(0.8) + 0.06*1), 1, 0)
  cv_cumlogit_lcpo3[k] <- ifelse(lci3 < (log(0.8) + 0.06*2) & uci3 > (log(0.8) + 0.06*2), 1, 0)
  cv_cumlogit_lcpo4[k] <- ifelse(lci4 < (log(0.8) + 0.06*3) & uci4 > (log(0.8) + 0.06*3), 1, 0)
  cv_cumlogit_lcpo5[k] <- ifelse(lci5 < (log(0.8) + 0.06*4) & uci5 > (log(0.8) + 0.06*4), 1, 0)
  cv_cumlogit_lcpo6[k] <- ifelse(lci6 < (log(0.8) + 0.06*5) & uci6 > (log(0.8) + 0.06*5), 1, 0)
  cv_cumlogit_lcpo7[k] <- ifelse(lci7 < (log(0.8) + 0.06*6) & uci7 > (log(0.8) + 0.06*6), 1, 0)
  cv_cumlogit_lcpo8[k] <- ifelse(lci8 < (log(0.8) + 0.06*7) & uci8 > (log(0.8) + 0.06*7), 1, 0)
  cv_cumlogit_lcpo9[k] <- ifelse(lci9 < (log(0.8) + 0.06*8) & uci9 > (log(0.8) + 0.06*8), 1, 0)
  cv_cumlogit_lcpo10[k] <- ifelse(lci10 < (log(0.8) + 0.06*9) & uci10 > (log(0.8) + 0.06*9), 1, 0)
  
  # MSE 
  mse_cumlogit_lcpo1[k] <- (as.numeric(summarise_draws(phi1, "median")[1,2]) - (log(0.8) + 0.06*0))^2
  mse_cumlogit_lcpo2[k] <- (as.numeric(summarise_draws(phi2, "median")[1,2]) - (log(0.8) + 0.06*1))^2
  mse_cumlogit_lcpo3[k] <- (as.numeric(summarise_draws(phi3, "median")[1,2]) - (log(0.8) + 0.06*2))^2
  mse_cumlogit_lcpo4[k] <- (as.numeric(summarise_draws(phi4, "median")[1,2]) - (log(0.8) + 0.06*3))^2
  mse_cumlogit_lcpo5[k] <- (as.numeric(summarise_draws(phi5, "median")[1,2]) - (log(0.8) + 0.06*4))^2
  mse_cumlogit_lcpo6[k] <- (as.numeric(summarise_draws(phi6, "median")[1,2]) - (log(0.8) + 0.06*5))^2
  mse_cumlogit_lcpo7[k] <- (as.numeric(summarise_draws(phi7, "median")[1,2]) - (log(0.8) + 0.06*6))^2
  mse_cumlogit_lcpo8[k] <- (as.numeric(summarise_draws(phi8, "median")[1,2]) - (log(0.8) + 0.06*7))^2
  mse_cumlogit_lcpo9[k] <- (as.numeric(summarise_draws(phi9, "median")[1,2]) - (log(0.8) + 0.06*8))^2
  mse_cumlogit_lcpo10[k] <- (as.numeric(summarise_draws(phi10, "median")[1,2]) - (log(0.8) + 0.06*9))^2
  ...
  # Extract summary for proportional OR 
  # Bias for each cumulative logit 
  bias_cumlogit_cpo1[k] <- as.numeric(summarise_draws(phi1, "median")[1,2]) - (log(0.8) + 0.06*0)
  bias_cumlogit_cpo2[k] <- as.numeric(summarise_draws(phi2, "median")[1,2]) - (log(0.8) + 0.06*1)
  bias_cumlogit_cpo3[k] <- as.numeric(summarise_draws(phi3, "median")[1,2]) - (log(0.8) + 0.06*2)
  bias_cumlogit_cpo4[k] <- as.numeric(summarise_draws(phi4, "median")[1,2]) - (log(0.8) + 0.06*3)
  bias_cumlogit_cpo5[k] <- as.numeric(summarise_draws(phi5, "median")[1,2]) - (log(0.8) + 0.06*4)
  bias_cumlogit_cpo6[k] <- as.numeric(summarise_draws(phi6, "median")[1,2]) - (log(0.8) + 0.06*5)
  bias_cumlogit_cpo7[k] <- as.numeric(summarise_draws(phi7, "median")[1,2]) - (log(0.8) + 0.06*6)
  bias_cumlogit_cpo8[k] <- as.numeric(summarise_draws(phi8, "median")[1,2]) - (log(0.8) + 0.06*7)
  bias_cumlogit_cpo9[k] <- as.numeric(summarise_draws(phi9, "median")[1,2]) - (log(0.8) + 0.06*8)
  bias_cumlogit_cpo10[k] <- as.numeric(summarise_draws(phi10, "median")[1,2]) - (log(0.8) + 0.06*9)
  ...
  cv_cumlogit_cpo1[k] <- ifelse(lci1 < (log(0.8) + 0.06*0) & uci1 > (log(0.8) + 0.06*0), 1, 0)
  cv_cumlogit_cpo2[k] <- ifelse(lci2 < (log(0.8) + 0.06*1) & uci2 > (log(0.8) + 0.06*1), 1, 0)
  cv_cumlogit_cpo3[k] <- ifelse(lci3 < (log(0.8) + 0.06*2) & uci3 > (log(0.8) + 0.06*2), 1, 0)
  cv_cumlogit_cpo4[k] <- ifelse(lci4 < (log(0.8) + 0.06*3) & uci4 > (log(0.8) + 0.06*3), 1, 0)
  cv_cumlogit_cpo5[k] <- ifelse(lci5 < (log(0.8) + 0.06*4) & uci5 > (log(0.8) + 0.06*4), 1, 0)
  cv_cumlogit_cpo6[k] <- ifelse(lci6 < (log(0.8) + 0.06*5) & uci6 > (log(0.8) + 0.06*5), 1, 0)
  cv_cumlogit_cpo7[k] <- ifelse(lci7 < (log(0.8) + 0.06*6) & uci7 > (log(0.8) + 0.06*6), 1, 0)
  cv_cumlogit_cpo8[k] <- ifelse(lci8 < (log(0.8) + 0.06*7) & uci8 > (log(0.8) + 0.06*7), 1, 0)
  cv_cumlogit_cpo9[k] <- ifelse(lci9 < (log(0.8) + 0.06*8) & uci9 > (log(0.8) + 0.06*8), 1, 0)
  cv_cumlogit_cpo10[k] <- ifelse(lci10 < (log(0.8) + 0.06*9) & uci10 > (log(0.8) + 0.06*9), 1, 0)

  
  # MSE 
  mse_cumlogit_cpo1[k] <- (as.numeric(summarise_draws(phi1, "median")[1,2]) - (log(0.8) + 0.06*0))^2
  mse_cumlogit_cpo2[k] <- (as.numeric(summarise_draws(phi2, "median")[1,2]) - (log(0.8) + 0.06*1))^2
  mse_cumlogit_cpo3[k] <- (as.numeric(summarise_draws(phi3, "median")[1,2]) - (log(0.8) + 0.06*2))^2
  mse_cumlogit_cpo4[k] <- (as.numeric(summarise_draws(phi4, "median")[1,2]) - (log(0.8) + 0.06*3))^2
  mse_cumlogit_cpo5[k] <- (as.numeric(summarise_draws(phi5, "median")[1,2]) - (log(0.8) + 0.06*4))^2
  mse_cumlogit_cpo6[k] <- (as.numeric(summarise_draws(phi6, "median")[1,2]) - (log(0.8) + 0.06*5))^2
  mse_cumlogit_cpo7[k] <- (as.numeric(summarise_draws(phi7, "median")[1,2]) - (log(0.8) + 0.06*6))^2
  mse_cumlogit_cpo8[k] <- (as.numeric(summarise_draws(phi8, "median")[1,2]) - (log(0.8) + 0.06*7))^2
  mse_cumlogit_cpo9[k] <- (as.numeric(summarise_draws(phi9, "median")[1,2]) - (log(0.8) + 0.06*8))^2
  mse_cumlogit_cpo10[k] <- (as.numeric(summarise_draws(phi10, "median")[1,2]) - (log(0.8) + 0.06*9))^2
  ...
  # Extract summary for proportional OR 
  # Bias for each cumulative logit 
  bias_cumlogit_lr1[k] <- as.numeric(summarise_draws(df, "median")[2,2]) - (log(0.8) + 0.06*0)
  ...
  cv_cumlogit_lr1[k] <- ifelse(lci < (log(0.8) + 0.06*0) & uci > (log(0.8) + 0.06*0), 1, 0)
  
  # MSE 
  mse_cumlogit_lr1[k] <- (as.numeric(summarise_draws(df, "median")[2,2]) - (log(0.8) + 0.06*0))^2
  ...
  # Extract summary for proportional OR 
  # Bias for each cumulative logit 
  bias_cumlogit_lr2[k] <- as.numeric(summarise_draws(df, "median")[2,2]) - (log(0.8) + 0.06*1)
  
  # Coverage - does the true value fall in the credible interval?
  lci <- as.numeric(summarise_draws(df, function(x) quantile(x, probs = c(0.025, 0.975)))[2,2])
  uci <- as.numeric(summarise_draws(df, function(x) quantile(x, probs = c(0.025, 0.975)))[2,3])
  
  cv_cumlogit_lr2[k] <- ifelse(lci < (log(0.8) + 0.06*1) & uci > (log(0.8) + 0.06*1), 1, 0)
  
  # MSE 
  mse_cumlogit_lr2[k] <- (as.numeric(summarise_draws(df, "median")[2,2]) - (log(0.8) + 0.06*1))^2
  ...
  # Extract summary for proportional OR 
  # Bias for each cumulative logit 
  bias_cumlogit_lr3[k] <- as.numeric(summarise_draws(df, "median")[2,2]) - (log(0.8) + 0.06*2)
  
  # Coverage - does the true value fall in the credible interval?
  lci <- as.numeric(summarise_draws(df, function(x) quantile(x, probs = c(0.025, 0.975)))[2,2])
  uci <- as.numeric(summarise_draws(df, function(x) quantile(x, probs = c(0.025, 0.975)))[2,3])
  
  cv_cumlogit_lr3[k] <- ifelse(lci < (log(0.8) + 0.06*2) & uci > (log(0.8) + 0.06*2), 1, 0)
  
  # MSE 
  mse_cumlogit_lr3[k] <- (as.numeric(summarise_draws(df, "median")[2,2]) - (log(0.8) + 0.06*2))^2
  ...
  # Extract summary for proportional OR 
  # Bias for each cumulative logit 
  bias_cumlogit_lr4[k] <- as.numeric(summarise_draws(df, "median")[2,2]) - (log(0.8) + 0.06*3)
  
  # Coverage - does the true value fall in the credible interval?
  lci <- as.numeric(summarise_draws(df, function(x) quantile(x, probs = c(0.025, 0.975)))[2,2])
  uci <- as.numeric(summarise_draws(df, function(x) quantile(x, probs = c(0.025, 0.975)))[2,3])
  
  cv_cumlogit_lr4[k] <- ifelse(lci < (log(0.8) + 0.06*3) & uci > (log(0.8) + 0.06*3), 1, 0)
  
  # MSE 
  mse_cumlogit_lr4[k] <- (as.numeric(summarise_draws(df, "median")[2,2]) - (log(0.8) + 0.06*3))^2
  ...
  # Extract summary for proportional OR 
  # Bias for each cumulative logit 
  bias_cumlogit_lr5[k] <- as.numeric(summarise_draws(df, "median")[2,2]) - (log(0.8) + 0.06*4)
  
  # Coverage - does the true value fall in the credible interval?
  lci <- as.numeric(summarise_draws(df, function(x) quantile(x, probs = c(0.025, 0.975)))[2,2])
  uci <- as.numeric(summarise_draws(df, function(x) quantile(x, probs = c(0.025, 0.975)))[2,3])
  
  cv_cumlogit_lr5[k] <- ifelse(lci < (log(0.8) + 0.06*4) & uci > (log(0.8) + 0.06*4), 1, 0)
  
  # MSE 
  mse_cumlogit_lr5[k] <- (as.numeric(summarise_draws(df, "median")[2,2]) - (log(0.8) + 0.06*4))^2
  ...
  # Extract summary for proportional OR 
  # Bias for each cumulative logit 
  bias_cumlogit_lr6[k] <- as.numeric(summarise_draws(df, "median")[2,2]) - (log(0.8) + 0.06*5)
  
  # Coverage - does the true value fall in the credible interval?
  lci <- as.numeric(summarise_draws(df, function(x) quantile(x, probs = c(0.025, 0.975)))[2,2])
  uci <- as.numeric(summarise_draws(df, function(x) quantile(x, probs = c(0.025, 0.975)))[2,3])
  
  cv_cumlogit_lr6[k] <- ifelse(lci < (log(0.8) + 0.06*5) & uci > (log(0.8) + 0.06*5), 1, 0)
  
  # MSE 
  mse_cumlogit_lr6[k] <- (as.numeric(summarise_draws(df, "median")[2,2]) - (log(0.8) + 0.06*5))^2
  ...
  # Extract summary for proportional OR 
  # Bias for each cumulative logit 
  bias_cumlogit_lr7[k] <- as.numeric(summarise_draws(df, "median")[2,2]) - (log(0.8) + 0.06*6)
  
  # Coverage - does the true value fall in the credible interval?
  lci <- as.numeric(summarise_draws(df, function(x) quantile(x, probs = c(0.025, 0.975)))[2,2])
  uci <- as.numeric(summarise_draws(df, function(x) quantile(x, probs = c(0.025, 0.975)))[2,3])
  
  cv_cumlogit_lr7[k] <- ifelse(lci < (log(0.8) + 0.06*6) & uci > (log(0.8) + 0.06*6), 1, 0)
  
  # MSE 
  mse_cumlogit_lr7[k] <- (as.numeric(summarise_draws(df, "median")[2,2]) - (log(0.8) + 0.06*6))^2
  ...
  # Extract summary for proportional OR 
  # Bias for each cumulative logit 
  bias_cumlogit_lr8[k] <- as.numeric(summarise_draws(df, "median")[2,2]) - (log(0.8) + 0.06*7)
  
  # Coverage - does the true value fall in the credible interval?
  lci <- as.numeric(summarise_draws(df, function(x) quantile(x, probs = c(0.025, 0.975)))[2,2])
  uci <- as.numeric(summarise_draws(df, function(x) quantile(x, probs = c(0.025, 0.975)))[2,3])
  
  cv_cumlogit_lr8[k] <- ifelse(lci < (log(0.8) + 0.06*7) & uci > (log(0.8) + 0.06*7), 1, 0)
  
  # MSE 
  mse_cumlogit_lr8[k] <- (as.numeric(summarise_draws(df, "median")[2,2]) - (log(0.8) + 0.06*7))^2
  ...
  # Extract summary for proportional OR 
  # Bias for each cumulative logit 
  bias_cumlogit_lr9[k] <- as.numeric(summarise_draws(df, "median")[2,2]) - (log(0.8) + 0.06*8)
  
  # Coverage - does the true value fall in the credible interval?
  lci <- as.numeric(summarise_draws(df, function(x) quantile(x, probs = c(0.025, 0.975)))[2,2])
  uci <- as.numeric(summarise_draws(df, function(x) quantile(x, probs = c(0.025, 0.975)))[2,3])
  
  cv_cumlogit_lr9[k] <- ifelse(lci < (log(0.8) + 0.06*8) & uci > (log(0.8) + 0.06*8), 1, 0)
  
  # MSE 
  mse_cumlogit_lr9[k] <- (as.numeric(summarise_draws(df, "median")[2,2]) - (log(0.8) + 0.06*8))^2
  ...
  # Extract summary for proportional OR 
  # Bias for each cumulative logit 
  bias_cumlogit_lr10[k] <- as.numeric(summarise_draws(df, "median")[2,2]) - (log(0.8) + 0.06*9)
  
  # Coverage - does the true value fall in the credible interval?
  lci <- as.numeric(summarise_draws(df, function(x) quantile(x, probs = c(0.025, 0.975)))[2,2])
  uci <- as.numeric(summarise_draws(df, function(x) quantile(x, probs = c(0.025, 0.975)))[2,3])
  
  cv_cumlogit_lr10[k] <- ifelse(lci < (log(0.8) + 0.06*9) & uci > (log(0.8) + 0.06*9), 1, 0)
  
  # MSE 
  mse_cumlogit_lr10[k] <- (as.numeric(summarise_draws(df, "median")[2,2]) - (log(0.8) + 0.06*9))^2
...
save(data, file = paste0("smalln_sym_11cat_linear",datnum,".Rdata"))

...
setwd("/group/cebu1/BACKUP/Chris/Project_2/Main_Simulations/Moderate_n/Symmetric/Eleven_categories/Random_PO/Small_effect/Moderate")
...
load("smalln_sym_11cat_randompo_smalleff_moderate_dataset.Rdata")
attach(big_data)
...
for (k in s1[datnum]:s2[datnum]){
  ...
  bias_cumlogit_po1[k] <- as.numeric(summarise_draws(df, "median")[11,2]) - log(1.10)
  bias_cumlogit_po2[k] <- as.numeric(summarise_draws(df, "median")[11,2]) - log(1.10)
  bias_cumlogit_po3[k] <- as.numeric(summarise_draws(df, "median")[11,2]) - log(1.10)
  bias_cumlogit_po4[k] <- as.numeric(summarise_draws(df, "median")[11,2]) - log(1.10)
  bias_cumlogit_po5[k] <- as.numeric(summarise_draws(df, "median")[11,2]) - log(1.10)
  bias_cumlogit_po6[k] <- as.numeric(summarise_draws(df, "median")[11,2]) - log(1.10)
  bias_cumlogit_po7[k] <- as.numeric(summarise_draws(df, "median")[11,2]) - log(1.10)
  bias_cumlogit_po8[k] <- as.numeric(summarise_draws(df, "median")[11,2]) - log(1.10)
  bias_cumlogit_po9[k] <- as.numeric(summarise_draws(df, "median")[11,2]) - log(1.10)
  ...
  cv_cumlogit_po7[k] <- ifelse(lci < log(1.10) & uci > log(1.10), 1, 0)
  cv_cumlogit_po8[k] <- ifelse(lci < log(1.10) & uci > log(1.10), 1, 0)
  cv_cumlogit_po9[k] <- ifelse(lci < log(1.10) & uci > log(1.10), 1, 0)
  cv_cumlogit_po10[k] <- ifelse(lci < log(1.10) & uci > log(1.10), 1, 0)

  
  # MSE 
  mse_cumlogit_po1[k] <- (as.numeric(summarise_draws(df, "median")[11,2]) - log(1.10))^2
  mse_cumlogit_po2[k] <- (as.numeric(summarise_draws(df, "median")[11,2]) - log(1.10))^2
  mse_cumlogit_po3[k] <- (as.numeric(summarise_draws(df, "median")[11,2]) - log(1.10))^2
  mse_cumlogit_po4[k] <- (as.numeric(summarise_draws(df, "median")[11,2]) - log(1.10))^2
  mse_cumlogit_po5[k] <- (as.numeric(summarise_draws(df, "median")[11,2]) - log(1.10))^2
  mse_cumlogit_po6[k] <- (as.numeric(summarise_draws(df, "median")[11,2]) - log(1.10))^2
  mse_cumlogit_po7[k] <- (as.numeric(summarise_draws(df, "median")[11,2]) - log(1.10))^2
  mse_cumlogit_po8[k] <- (as.numeric(summarise_draws(df, "median")[11,2]) - log(1.10))^2
  mse_cumlogit_po9[k] <- (as.numeric(summarise_draws(df, "median")[11,2]) - log(1.10))^2
  ...
  # Extract summary for proportional OR 
  # Bias for each cumulative logit 
  bias_cumlogit_ppo1[k] <- as.numeric(summarise_draws(df, "median")[11,2]) - log(1.10)
  ...
  bias_cumlogit_ppo7[k] <- as.numeric(summarise_draws(phi6, "median")[1,2]) - log(1.10)
  bias_cumlogit_ppo8[k] <- as.numeric(summarise_draws(phi7, "median")[1,2]) - log(1.10)
  bias_cumlogit_ppo9[k] <- as.numeric(summarise_draws(phi8, "median")[1,2]) - log(1.10)
  ...
  cv_cumlogit_ppo7[k] <- ifelse(lci7 < log(1.10) & uci7 > log(1.10), 1, 0)
  cv_cumlogit_ppo8[k] <- ifelse(lci8 < log(1.10) & uci8 > log(1.10), 1, 0)
  cv_cumlogit_ppo9[k] <- ifelse(lci9 < log(1.10) & uci9 > log(1.10), 1, 0)
  cv_cumlogit_ppo10[k] <- ifelse(lci10 < log(1.10) & uci10 > log(1.10), 1, 0)

  
  # MSE 
  mse_cumlogit_ppo1[k] <- (as.numeric(summarise_draws(df, "median")[11,2]) - log(1.10))^2
  ...
  mse_cumlogit_ppo7[k] <- (as.numeric(summarise_draws(phi6, "median")[1,2]) - log(1.10))^2
  mse_cumlogit_ppo8[k] <- (as.numeric(summarise_draws(phi7, "median")[1,2]) - log(1.10))^2
  mse_cumlogit_ppo9[k] <- (as.numeric(summarise_draws(phi8, "median")[1,2]) - log(1.10))^2
  ...
  bias_cumlogit_lcpo7[k] <- as.numeric(summarise_draws(phi7, "median")[1,2]) - log(1.10)
  bias_cumlogit_lcpo8[k] <- as.numeric(summarise_draws(phi8, "median")[1,2]) - log(1.10)
  bias_cumlogit_lcpo9[k] <- as.numeric(summarise_draws(phi9, "median")[1,2]) - log(1.10)
  ...
  cv_cumlogit_lcpo7[k] <- ifelse(lci7 < log(1.10) & uci7 > log(1.10), 1, 0)
  cv_cumlogit_lcpo8[k] <- ifelse(lci8 < log(1.10) & uci8 > log(1.10), 1, 0)
  cv_cumlogit_lcpo9[k] <- ifelse(lci9 < log(1.10) & uci9 > log(1.10), 1, 0)
  ...
  mse_cumlogit_lcpo7[k] <- (as.numeric(summarise_draws(phi7, "median")[1,2]) - log(1.10))^2
  mse_cumlogit_lcpo8[k] <- (as.numeric(summarise_draws(phi8, "median")[1,2]) - log(1.10))^2
  mse_cumlogit_lcpo9[k] <- (as.numeric(summarise_draws(phi9, "median")[1,2]) - log(1.10))^2
  ...
  cppomoddiv <- blrm(y~x,ppo = ~x, normcppo=F,
                     priorsdppo = 100,
                     conc = 1, seed=1234,iter=7500,chains=4,cppo=function(y) y==11,sampling.args = list(cores = 4,control=list(adapt_delta=0.95,max_treedepth=12)))
  ...
  bias_cumlogit_cpo7[k] <- as.numeric(summarise_draws(phi7, "median")[1,2]) - log(1.10)
  bias_cumlogit_cpo8[k] <- as.numeric(summarise_draws(phi8, "median")[1,2]) - log(1.10)
  bias_cumlogit_cpo9[k] <- as.numeric(summarise_draws(phi9, "median")[1,2]) - log(1.10)
  ...
  cv_cumlogit_cpo7[k] <- ifelse(lci7 < log(1.10) & uci7 > log(1.10), 1, 0)
  cv_cumlogit_cpo8[k] <- ifelse(lci8 < log(1.10) & uci8 > log(1.10), 1, 0)
  cv_cumlogit_cpo9[k] <- ifelse(lci9 < log(1.10) & uci9 > log(1.10), 1, 0)
  ...
  mse_cumlogit_cpo7[k] <- (as.numeric(summarise_draws(phi7, "median")[1,2]) - log(1.10))^2
  mse_cumlogit_cpo8[k] <- (as.numeric(summarise_draws(phi8, "median")[1,2]) - log(1.10))^2
  mse_cumlogit_cpo9[k] <- (as.numeric(summarise_draws(phi9, "median")[1,2]) - log(1.10))^2
  ...
  # Extract summary for proportional OR 
  # Bias for each cumulative logit 
  bias_cumlogit_lr7[k] <- as.numeric(summarise_draws(df, "median")[2,2]) - log(1.10)
  
  # Coverage - does the true value fall in the credible interval?
  lci <- as.numeric(summarise_draws(df, function(x) quantile(x, probs = c(0.025, 0.975)))[2,2])
  uci <- as.numeric(summarise_draws(df, function(x) quantile(x, probs = c(0.025, 0.975)))[2,3])
  
  cv_cumlogit_lr7[k] <- ifelse(lci < log(1.10) & uci > log(1.10), 1, 0)
  
  # MSE 
  mse_cumlogit_lr7[k] <- (as.numeric(summarise_draws(df, "median")[2,2]) - log(1.10))^2
  ...
  # Extract summary for proportional OR 
  # Bias for each cumulative logit 
  bias_cumlogit_lr8[k] <- as.numeric(summarise_draws(df, "median")[2,2]) - log(1.10)
  
  # Coverage - does the true value fall in the credible interval?
  lci <- as.numeric(summarise_draws(df, function(x) quantile(x, probs = c(0.025, 0.975)))[2,2])
  uci <- as.numeric(summarise_draws(df, function(x) quantile(x, probs = c(0.025, 0.975)))[2,3])
  
  cv_cumlogit_lr8[k] <- ifelse(lci < log(1.10) & uci > log(1.10), 1, 0)
  
  # MSE 
  mse_cumlogit_lr8[k] <- (as.numeric(summarise_draws(df, "median")[2,2]) - log(1.10))^2
  ...
  # Extract summary for proportional OR 
  # Bias for each cumulative logit 
  bias_cumlogit_lr9[k] <- as.numeric(summarise_draws(df, "median")[2,2]) - log(1.10)
  
  # Coverage - does the true value fall in the credible interval?
  lci <- as.numeric(summarise_draws(df, function(x) quantile(x, probs = c(0.025, 0.975)))[2,2])
  uci <- as.numeric(summarise_draws(df, function(x) quantile(x, probs = c(0.025, 0.975)))[2,3])
  
  cv_cumlogit_lr9[k] <- ifelse(lci < log(1.10) & uci > log(1.10), 1, 0)
  
  # MSE 
  mse_cumlogit_lr9[k] <- (as.numeric(summarise_draws(df, "median")[2,2]) - log(1.10))^2
...
save(data, file = paste0("smalln_sym_11cat_randompo_smalleff_moderate",datnum,".Rdata"))

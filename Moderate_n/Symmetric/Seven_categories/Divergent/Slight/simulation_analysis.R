...
setwd("/group/cebu1/BACKUP/Chris/Project_2/Main_Simulations/Moderate_n/Symmetric/Seven_categories/Divergent/Slight")
...
load("smalln_sym_7cat_diverg_slight_dataset.Rdata")
attach(big_data)
...
save(data, file = paste0("smalln_sym_7cat_diverg_slight",datnum,".Rdata"))

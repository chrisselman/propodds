...
```{r}
library(miceadds)
data <- do.call(rbind,lapply(paste0("smalln_sym_7cat_diverg_slight",c(1:50),".Rdata"), load.Rdata2))
...
effectsize <- rep("Small [1.10]", 30)

truemod <- rep("Divergent", 30)
...
save(results, file = "smalln_sym_7cat_diverg_slight_results.Rdata")
write.csv(results,file="G:/BACKUP/Chris/Project_2/Main_Simulations/Results/results_52.csv")

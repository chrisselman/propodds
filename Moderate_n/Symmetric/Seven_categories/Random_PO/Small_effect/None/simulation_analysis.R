...
setwd("/group/cebu1/BACKUP/Chris/Project_2/Main_Simulations/Moderate_n/Symmetric/Seven_categories/Random_PO/Small_effect/None")
...
load("smalln_sym_7cat_randompo_smalleff_none_dataset.Rdata")
attach(big_data)
...
save(data, file = paste0("smalln_sym_7cat_randompo_smalleff_none",datnum,".Rdata"))

...
```{r}
library(miceadds)
data <- do.call(rbind,lapply(paste0("smalln_sym_7cat_linear",c(1:50),".Rdata"), load.Rdata2))
...
effectsize <- rep("0.06 increase", 30)

truemod <- rep("Linear", 30)

controlprob <- rep("Symmetric", 30)

sampsize <- rep(1500, 30)
...
save(results, file = "smalln_sym_7cat_linear_results.Rdata")
write.csv(results,file="G:/BACKUP/Chris/Project_2/Main_Simulations/Results/results_32.csv")

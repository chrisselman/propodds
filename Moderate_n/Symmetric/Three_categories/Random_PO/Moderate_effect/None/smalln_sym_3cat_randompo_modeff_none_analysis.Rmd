...
```{r}
library(miceadds)
data <- do.call(rbind,lapply(paste0("smalln_sym_3cat_randompo_modeff_none",1:50,".Rdata"), load.Rdata2))
...
save(results, file = "smalln_sym_3cat_randompo_modeff_none_results.Rdata")
write.csv(results,file="G:/BACKUP/Chris/Project_2/Main_Simulations/Results/results_39.csv")

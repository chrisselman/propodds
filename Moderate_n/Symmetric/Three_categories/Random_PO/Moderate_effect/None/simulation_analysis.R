...
setwd("/group/cebu1/BACKUP/Chris/Project_2/Main_Simulations/Moderate_n/Symmetric/Three_categories/Random_PO/Moderate_effect/None")
...
load("smalln_sym_3cat_randompo_modeff_none_dataset.Rdata")
attach(big_data)
...
save(data, file = paste0("smalln_sym_3cat_randompo_modeff_none",datnum,".Rdata"))

...
save(results, file = "largen_skew_3cat_linear_results.Rdata")
write.csv(results,paste("G:/BACKUP/Chris/Project_2/Main_Simulations/Results/results_60.csv"),row.names=F)

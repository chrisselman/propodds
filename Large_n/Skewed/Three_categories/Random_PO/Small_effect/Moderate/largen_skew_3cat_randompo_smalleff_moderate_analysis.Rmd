...
save(results, file = "largen_skew_3cat_randompo_smalleff_moderate_results.Rdata")
write.csv(results,file="G:/BACKUP/Chris/Project_2/Main_Simulations/Results/results_63.csv")

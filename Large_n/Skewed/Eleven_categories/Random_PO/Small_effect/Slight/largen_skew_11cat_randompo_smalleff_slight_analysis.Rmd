...
save(results, file = "largen_skew_11cat_randompo_smalleff_slight_results.Rdata")
write.csv(results,file="G:/BACKUP/Chris/Project_2/Main_Simulations/Results/results_76.csv",row.names=F)

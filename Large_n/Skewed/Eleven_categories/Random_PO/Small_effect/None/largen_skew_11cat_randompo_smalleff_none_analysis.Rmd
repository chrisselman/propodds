...
#for (i in 1:50) {
 # load(paste0("largen_skew_11cat_randompo_modeff_none",i,".Rdata"))
  #save(data,file = paste0("largen_skew_11cat_randompo_smalleff_none",i,".Rdata"))
#}


data <- do.call(rbind,lapply(paste0("largen_skew_11cat_randompo_smalleff_none",c(1:50),".Rdata"), load.Rdata2))
...
for(i in 1:nsim){
  ...
  MC_YMinusi_relbias3_ppo[i] = (exp(sum(bias_cumlogit_ppo3[-i])/(nsim-1) + log(1.1))-exp(log(1.1)))/(exp(log(1.1)))
  MC_YMinusi_relbias4_ppo[i] = (exp(sum(bias_cumlogit_ppo4[-i])/(nsim-1) + log(1.1))-exp(log(1.1)))/(exp(log(1.1)))
  MC_YMinusi_relbias5_ppo[i] = (exp(sum(bias_cumlogit_ppo5[-i])/(nsim-1) + log(1.1))-exp(log(1.1)))/(exp(log(1.1)))
  MC_YMinusi_relbias6_ppo[i] = (exp(sum(bias_cumlogit_ppo6[-i])/(nsim-1) + log(1.1))-exp(log(1.1)))/(exp(log(1.1)))
  MC_YMinusi_relbias7_ppo[i] = (exp(sum(bias_cumlogit_ppo7[-i])/(nsim-1) + log(1.1))-exp(log(1.1)))/(exp(log(1.1)))
  MC_YMinusi_relbias8_ppo[i] = (exp(sum(bias_cumlogit_ppo8[-i])/(nsim-1) + log(1.1))-exp(log(1.1)))/(exp(log(1.1)))
  MC_YMinusi_relbias9_ppo[i] = (exp(sum(bias_cumlogit_ppo9[-i])/(nsim-1) + log(1.1))-exp(log(1.1)))/(exp(log(1.1)))
  ...
  MC_YMinusi_relbias3_lcpo[i] = (exp(sum(bias_cumlogit_lcpo3[-i])/(nsim-1) + log(1.1))-exp(log(1.1)))/(exp(log(1.1)))
  MC_YMinusi_relbias4_lcpo[i] = (exp(sum(bias_cumlogit_lcpo4[-i])/(nsim-1) + log(1.1))-exp(log(1.1)))/(exp(log(1.1)))
  MC_YMinusi_relbias5_lcpo[i] = (exp(sum(bias_cumlogit_lcpo5[-i])/(nsim-1) + log(1.1))-exp(log(1.1)))/(exp(log(1.1)))
  MC_YMinusi_relbias6_lcpo[i] = (exp(sum(bias_cumlogit_lcpo6[-i])/(nsim-1) + log(1.1))-exp(log(1.1)))/(exp(log(1.1)))
  MC_YMinusi_relbias7_lcpo[i] = (exp(sum(bias_cumlogit_lcpo7[-i])/(nsim-1) + log(1.1))-exp(log(1.1)))/(exp(log(1.1)))
  MC_YMinusi_relbias8_lcpo[i] = (exp(sum(bias_cumlogit_lcpo8[-i])/(nsim-1) + log(1.1))-exp(log(1.1)))/(exp(log(1.1)))
  MC_YMinusi_relbias9_lcpo[i] = (exp(sum(bias_cumlogit_lcpo9[-i])/(nsim-1) + log(1.1))-exp(log(1.1)))/(exp(log(1.1)))
...
truemod <- rep("Random PO [no violation]", 50)
...
save(results, file = "largen_skew_13cat_randompo_smalleff_none_results.Rdata")
write.csv(results,file="G:/BACKUP/Chris/Project_2/Main_Simulations/Results/results_105.csv")

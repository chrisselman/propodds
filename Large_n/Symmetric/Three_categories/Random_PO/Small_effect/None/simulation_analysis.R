...
setwd("/group/cebu1/BACKUP/Chris/Project_2/Main_Simulations/Large_n/Symmetric/Three_categories/Random_PO/Small_effect/None")
...
save(data, file = paste0("largen_skew_3cat_randompo_smalleff_none",datnum,".Rdata"))

...
#for (i in 1:50) {
 # load(paste0("largen_skew_3cat_randompo_smalleff_none",i,".Rdata"))
  #save(data,file = paste0("largen_sym_3cat_randompo_smalleff_none",i,".Rdata"))
#}


data <- do.call(rbind,lapply(paste0("largen_sym_3cat_randompo_smalleff_none",1:50,".Rdata"), load.Rdata2))
...
truemod <- rep("Random PO [no violation]", 10)
...
save(results, file = "largen_sym_3cat_randompo_smalleff_none_results.Rdata")
write.csv(results,file="G:/BACKUP/Chris/Project_2/Main_Simulations/Results/results_70.csv")

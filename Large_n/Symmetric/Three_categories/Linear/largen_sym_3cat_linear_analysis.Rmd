...
save(results, file = "largen_sym_3cat_linear_results.Rdata")
write.csv(results,paste("G:/BACKUP/Chris/Project_2/Main_Simulations/Results/results_66.csv"),row.names=F)

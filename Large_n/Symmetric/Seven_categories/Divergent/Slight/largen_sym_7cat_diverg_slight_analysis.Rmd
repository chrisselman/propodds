...
```{r}
library(miceadds)
data <- do.call(rbind,lapply(paste0("largen_sym_7cat_diverg_slight",c(1:50),".Rdata"), load.Rdata2))
...
save(results, file = "largen_sym_7cat_diverg_slight_results.Rdata")
write.csv(results,file="G:/BACKUP/Chris/Project_2/Main_Simulations/Results/results_97.csv")

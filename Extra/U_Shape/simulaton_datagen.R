...
getProbs <- function(p0 = c(10, 40, 10,40)/100)
{
  ...
  for (i in 1:(length(p0)-1)){
    cumlogOdds1[i] <- cumlogOdds0[i] - (0.5605425 - 0.17058525*i + 0.01550775*i^2)
  }
...
simulateTrial <- function(nSamples0,
                          nSamples1,
...
save(big_data, file = "vlargen_skew_11cat_ushape_dataset.Rdata")

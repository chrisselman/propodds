...
setwd("/group/cebu1/BACKUP/Chris/Project_2/Main_Simulations/Extra/Zero_Cat/Divergent/Moderate")
...
load("vlargen_zero_11cat_diverg_moderate_dataset.Rdata")
attach(big_data)
...
save(data, file = paste0("vlargen_zero_11cat_diverg_moderate",datnum,".Rdata"))
